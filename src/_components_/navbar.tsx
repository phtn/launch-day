...
export const Navbar = () => {
  ...
  return (
    <nav className='z-200 md:h-16 h-12 border-b border-base-300 w-full justify-between bg-black/80 backdrop-blur-2xl hover:bg-black/20 hover:backdrop-blur-2xl fixed top-0 flex items-center gap-8 ps-2 md:px-8'>

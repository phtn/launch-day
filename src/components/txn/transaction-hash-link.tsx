...
export function TransactionHashLink({
  ...
  if (explorerUrl) {
    return (
      <a
        ...
        className={cn('font-mono underline truncate text-emerald-300 hover:text-emerald-200', linkClassName, className)}>
        {display}
      </a>
    )
  }
  ...
  return (
    <span className={cn('font-mono truncate text-white/60', className)}>{display}</span>
  )
}

      ...
      <motion.div
        ...
        <div className='p-4 border-b decoration-1 border-white/10 space-y-1'>
          <div className='flex items-center space-x-0'>
            <h3 className='p-2 font-brk text-xs md:text-sm uppercase opacity-70 text-slate-300'>You pay</h3>
          ...
          <div className='flex items-center justify-between text-xs md:text-sm'>
            ...
            <div className='flex items-center space-x-8'>
              <button
                ...
                <Icon
                  name='qrcode'
                  className={cn('size-4 md:size-6 text-white ', { 'text-slate-300/50': !paymentRequestUri })}
                />
              </button>
              <button

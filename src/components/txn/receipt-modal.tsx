            ...
            <motion.div
              ...
              <div className='relative px-5 pt-5 pb-1'>
                <div className='flex items-center justify-between mb-4'>
                  <h2 id='receipt-modal-title' className='font-polyn font-bold text-lg text-white/90'>
                    Payment Receipt
                  </h2>
                  <button
                    type='button'
                ...
                <div className='space-y-3 rounded-xl border border-white/10 bg-white/5 p-4'>
                  <div className='flex justify-between text-sm'>
                    <span className='text-white/50 font-exo uppercase italic'>Amount</span>
                    <span className='font-okxs text-white'>
                      {amount} <span className='uppercase text-white/70'>{symbol}</span>
                    </span>
                  </div>
                  {usdValue !== null && (
                    <div className='flex justify-between text-sm'>
                      <span className='text-white/50 font-exo uppercase italic'>USD</span>
                      <span className='font-okxs text-white'>
                  ...
                  {recipient && (
                    <div className='flex justify-between text-sm gap-2'>
                      <span className='text-white/50 font-exo uppercase italic shrink-0'>To</span>
                      <span className='font-mono text-xs text-white/80 truncate text-right'>{recipient}</span>
                    </div>
                  )}
                  ...
                  {hash && (
                    <div className='flex flex-col gap-1 pt-1'>
                      <span className='text-white/50 font-exo uppercase italic text-xs'>Transaction</span>
                      <TransactionHashLink
                        hash={hash}
